        ...
        if (played1 == false) {
            ...
            if (this.count == 2)
                if (this.count == 2) {
                    ...
                    this.add.text(363, 400, "And This is Your Teacher:\n She speaks LOOOOUdly\n                         -->", credit2Config)
                }
            if (this.count == 3) {

                this.add.text(790, 100, "Your Goal: \nEat up your chips\n 'without been caught!' \n Press Space to Eat! \n ->[ SPACE ]<-", credit2Config)
            }
            if (this.count == 4) {
                this.beat = this.add.sprite(700, 480, 'square').setScale(0.05);
                this.beat = this.add.sprite(800, 480, 'square').setScale(0.05);
                this.beat = this.add.sprite(900, 480, 'square').setScale(0.05);
                this.add.text(693, 317, "This bar here Shows\nwhen will the teacher speak\n     |      |      |\n     v     v     v", credit2Config);
            }
            if (this.count == 5) {
                // this.student1 = this.add.sprite(680, 438, 'girl').setOrigin(0.0).setScale(1.1);
                this.add.text(859, 550, "When she open her Mouth\n Eat Your Chips!!!!\n Eat em up before the Class Over!", credit2Config)
            }
            if (this.count == 6) {
