class Instru extends Phaser.Scene {
    ...
    create() {
        ...
        this.count = 0;
        let menu1Config = { fontFamily: 'Minecraftia', fontSize: '50px', color: '#ffff00', stroke: '#000000', strokeThickness: 3, padding: { top: 5, bottom: 5, }, fixedWidth: 0 }
        if (newGame == true) {
    ...
    nextline() {
        ...
        if (newGame == true) {
            ...
            if (this.count == 6) {
                this.text6 = this.add.text(290, 230, "Let's  Go!", textConfig2);
            } else if (this.count == 7) {
                this.text6.destroy();
            }
            if (this.count == 7) {
